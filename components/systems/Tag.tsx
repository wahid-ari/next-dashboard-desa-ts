...
export default function Tag({ className, noX, isLarge, children, ...props }: Props) {
  return (
    <span
      {...props}
      className={`${
...
Tag.dark = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
...
Tag.red = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
...
Tag.green = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
...
Tag.yellow = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
...
Tag.indigo = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
...
Tag.purple = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
...
Tag.pink = ({ className, noX, isLarge, children, ...props }: Props) => {
  return (
    <span
      {...props}
      className={`${
