...
export default function Dialog({ open, setOpen, title, children, isDanger, onClose, onConfirm, showIcon }: Props) {
  return (
    <DialogRadix.Root open={open} onOpenChange={setOpen}>
      <Transition.Root show={open}>
        ...
        >
          ...
          >
            <DialogRadix.Close className='absolute right-3.5 top-3.5 rounded p-1 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-sky-500'>
